...
| **07-31** (day 9) | **B1 retrain** (top unstarted candidate, and no longer blocked behind the Crispin anchor); re-mine 07-30 episodes (they publish this day); **B4 branching probe** | matchup win-rate matrix among high-rated players; start `STRATEGY.md` skeleton | a second measured improvement in hand → a bundle worth submitting |
